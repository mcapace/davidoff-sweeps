        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="md:hidden p-2 transition-colors text-davidoff-black hover:text-davidoff-gold focus:outline-none focus:ring-2 focus:ring-davidoff-gold/50 focus:ring-offset-2 rounded-sm border-2 border-stone-300 hover:border-davidoff-gold focus:border-davidoff-gold"
